...
Element Selection: It selects the input field, button, and task list using getElementById.
...
Delete Task: Each task includes a "Delete" button that removes the task when clicked.

UI Update: The new task is added to the list, and the input field is cleared for the next entry.
